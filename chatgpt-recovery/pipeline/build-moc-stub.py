...
def main():
    ...
    lines = [
        ...
        'tags: [moc, chatgpt-recovery, chatgpt-import, raw-collection]',
        ...
        'Pipeline: brianjlacy/export-chatgpt -> BERTopic clustering -> Qwen 14B Q2 labeling -> atomize per-message Cards.',
        '',
        '## Stats',
        '',
        ...
        '- Atomization method: per-message section-atomize with vault-convention frontmatter',
        '',
        '## Source',
        '',
        ...
        '- Pipeline runbook: [chatgpt-recovery/](https://github.com/MasterDD-L34D/codemasterdd-ai-station/tree/main/chatgpt-recovery)',
        '',
        '## Topics overview',
        '',
    ...
    lines.extend([
        '## Review workflow',
        '',
        '1. Open [[../_processed/classification/topics-summary|topics-summary.md]] for full topic detail',
        f'2. Run sample-cards.py + review [[review-sample-{args.export_date}|review-sample-{args.export_date}.md]] (~143 cards)',
        '3. For each topic mark disposition: PROMOTE / RENAME-THEN-PROMOTE / HOLD / DISCARD',
        '4. Run promote-cards.py with dry-run, then full',
        f'5. Promoted cards land in `Spaces/<space>/_imported-{args.export_date}/<topic>/`',
        '',
        '## Promotion log',
        '',
        '_(filled by promote-cards.py post-review)_',
        '',
        '## Caveats',
        '',
        ...
        '## Cross-references',
        '',
        '- ADR governance: [[../../docs/adr/0030-chatgpt-recovery-classification-pipeline|ADR-0030]]',
        '- Agent lessons: [chatgpt-recovery/agent-lessons-2026-05-14.md](https://github.com/MasterDD-L34D/codemasterdd-ai-station/blob/main/chatgpt-recovery/agent-lessons-2026-05-14.md)',
        '- Vault cross-reference map: [chatgpt-recovery/vault-cross-reference-map.yaml](https://github.com/MasterDD-L34D/codemasterdd-ai-station/blob/main/chatgpt-recovery/vault-cross-reference-map.yaml)',
        '',
    ])
