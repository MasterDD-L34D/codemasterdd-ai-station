...
| **Spore** (2008) | Part-pack assembly, ability auto-derivata da parti, mutazione morfologica runtime | RIFIUTA sandbox real-time; 6-pattern stack: slot morfologia, ability auto-derive, DNA budget, visual swap obbligatorio, ereditarieta' generazionale, part-bingo. Path moderato ~21h chiude P2 | museum `spore-part-pack-runtime-stack.md` (5/5); vault `core/20-SPECIE_E_PARTI.md`,`00-SOURCE-OF-TRUTH.md` §20+§24.6 D-HEIR/D-REPRO | **CANONICAL Fase-1** (part-pack sbloccato 2026-05-26: SoT §24.6 + ADR-2026-05-26 scoped-supersede freeze §21.3) + **Fase-3 epigenome/Lamarck-lite SHIPPED** (Game #2402, 2026-05-28); DEFERRED restano genealogie profonde + eco-repro lungo-termine |
...
- Genetics: Fase-1 part-pack **sbloccata** + **Fase-3 epigenome/Lamarck-lite SHIPPED** (Game #2402 `c359b576`, 2026-05-28); restano deferred genealogie profonde + eco-repro lungo-termine
