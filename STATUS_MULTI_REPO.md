...
| **Game (Evo-Tactics Vue3)** | HEAD main `05af47e9` (Ryzen synced 2026-05-28). Clean. **Fase-3 epigenome SHIPPED full**: engine #2402 + live loop (CreatureEpigenome store/migration 0015 + session-end accumulation + mating hydration + speciation) #2404 + lineage sim #2407 + weight 0.45 #2409 + hardening (registry scope/prune + prisma DI) #2412 + games-index Niche/Creatures #2405. Suite 1333/0-fail. DRAFT PR #2385 still open (weekly drift, low-pri triage). | Playtest live (L-069, the Nord) + triage #2385 | -- | Nessuno |
