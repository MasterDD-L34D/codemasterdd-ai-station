...
**Finestra**: dal 2026-04-22 a oggi.

**Cicli inclusi**: 391 entry significative (esiti ✅/💡/🌿/⬆️).

---

## TL;DR per Game team

- **120 cicli su biomi**: probabili candidati a documentazione/asset Game (vedi sezione 🌍).
- **50 cicli su specie/creature**: design pronto per asset team.
...
- **22 cicli su lore**: hook narrativi pronti per scrittore/director.
...
- **`dune_stalker`** ↔ canonical `dune_stalker` (IT: Dune Stalker / EN: Dune Stalker) — cicli #2, #119, #2
...
- Path: `C:\dev\Game`
- HEAD: `3181e2db feat(combat): wire terrain reactions bridge + TTL decay (CAP-07 MVP)`
