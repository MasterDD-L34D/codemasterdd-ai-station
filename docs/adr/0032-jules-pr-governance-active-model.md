...
- **Status**: **SUPERSEDED by ADR-0033** (2026-05-17). Mai ratificato. Esecuzione empirica + Archon 7-step + arbitro esterno indipendente (82% confidence, ground-truth-verified) hanno dimostrato che il modello attivo-su-repo-esterni e' net-negative (0 merge Jules attribuibili a Model-3-active, 2 backfire innescati DAL corrective, 69% falso-positivo CLOSE, gate "no-incident" gia' fallito). La tassonomia S1-S7 + 3-obblighi + no-silent-close + lesson L-031 SOPRAVVIVONO in ADR-0033 (incorporati nella verdict-logic del triager read-only, NON come azioni attive Claude su repo esterni). Vedi `docs/adr/0033-jules-governance-resolved.md`.
- **Status storico**: Proposed (2026-05-17 pre-ratification, mai Accepted)
- **Data**: 2026-05-17
