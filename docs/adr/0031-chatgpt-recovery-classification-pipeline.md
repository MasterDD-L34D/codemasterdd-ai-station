...
- STATUS-CHECK: 2026-06-14 | trigger: bulk-export PASS + classify.py smoke PASS | default-if-elapsed: Escalate
- **Data**: 2026-05-14
...
- **Cross-LLM applicability**: pipeline BERTopic + nomic + Qwen locale e' generica per qualsiasi corpus chat JSON (Gemini takeout, Claude export, Perplexity history). Documentare come pattern riusabile in `docs/reference/patterns/` post-run se risultato positivo.
