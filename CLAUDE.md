...
- Modelli locali:
  ...
  - **Modelli pullati 2026-04-22 da valutare** (task #13): `deepseek-r1:8b` (5.2 GB) + `gpt-oss:120b` (65 GB) + `qwen2.5-coder:32b` (19 GB, bench PASS ma 3.65 tok/s → SCARTATO tier routing ADR-0012)
