...
| Game-Database | **DONE** (Phase C versioning loop, #165 merged 05-25). Post-Short: wave Jules code-health 12 PR (CWE-290 #170, rate-limit #169, test/JSDoc). **Next Short (ratificato 06-11): versioned reads Biome/Species/Eco** (pull-down dal Mid) | versioned reads Biome/Species/Eco; bidi-sync RFC #4 scoping; audit-UI hardening | Robust versioned auditable content backend (evo:import) | feeds Game |
...
- **Game-Database**: versioned reads Biome/Species/Eco (pull-down dal Mid, post-#165).
