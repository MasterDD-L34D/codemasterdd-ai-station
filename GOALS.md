...
| Game-Database | **DONE same-day** (versioned reads B/S/E, #180 merged 06-11: contratto #179 + Jules dispatch + triage; loop versioning end-to-end CHIUSO). **Next Short (ratificato 06-11, 2a): scoping RFC #4 bidi-sync** -- DB come SoT, export verso Game pack catalog (RFC in PR #182, ladder S0->S3 + 8 OQ) | audit-UI hardening; RFC #4 fasi S2+ post-ratifica | Robust versioned auditable content backend (evo:import) | feeds Game |
