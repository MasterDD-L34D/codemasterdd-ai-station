...
| OD-007 | AA01 capability registry / scan automatico? | ✅ CLOSED 2026-05-28 (DUPLICATE: ARCHON D-007 + `aa01/archon/skills/agent-scanner` gia' built; STRONG-SKIP ratificato via dogfood `FIRST_PRINCIPLES_INFRA_CHECKLIST.md`) | Action AA01-side opzionale (Eduardo): linka skill in `aa01/AGENTS.md` drill-down. Codemasterdd niente |
...
- **Action AA01-side opzionale (Eduardo-direct, fuori scope codemasterdd)**: aggiungi 1-2 righe in `aa01/AGENTS.md` sezione DRILL-DOWN -> link `archon/skills/agent-scanner/SKILL.md`. Validation = prima AA01 task successiva invoca scanner senza memoria episodica.
